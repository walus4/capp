...
namespace Capgemini.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICustomerServece, CutomerService>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            Mapper.Initialize(cfg =>
            {
                ...
                cfg.CreateMap<IEnumerable<CustormerDTO>,IEnumerable<Customer>>();
                cfg.CreateMap<IEnumerable<Customer>,IEnumerable<CustormerDTO>>();
